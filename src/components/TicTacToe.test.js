...
it("should start a new game after 'Start over' button is pressed", async () => {
  ...
  await waitForElement(() => getByText("click on X if you want to play first and computer will play second else choose 0"));
  expect(getByText("click on X if you want to play first and computer will play second else choose 0")).toBeInTheDocument();
});
